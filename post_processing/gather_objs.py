...
# Objectives of the perturbed versions of the compromise solution (to change)
objs_by_rdm_dir_p = '/home/fs02/pmr82_0001/lbl59/Implementation_Uncertainty/WaterPaths_duReeval/' + \
                    'Objectives_' + compSol + '_perturbed/Objectives_RDM'

# Objectives of the original compromise solution (to change)
objs_by_rdm_dir_o = '/home/fs02/pmr82_0001/lbl59/Implementation_Uncertainty/WaterPaths_duReeval/' + \
                    'Objectives_' + compSol + '_soln/Objectives_RDM'

# where mean of all perturbed objectives across all RDMs is stored (to change)
fileoutpath_byRDMs = '/home/fs02/pmr82_0001/lbl59/Implementation_Uncertainty/' + \
    'post_processing/' + compSol_full + '/meanObjs_acrossRDM_'
# where mean of all perturbed objectives across all solutions is stored (to change)
fileoutpath_bySoln = '/home/fs02/pmr82_0001/lbl59/Implementation_Uncertainty/' + \
    'post_processing/' + compSol_full + '/meanObjs_acrossSoln_'
# where original objectives across all RDMs is stored (to change)
fileoutpath_byRDMs_og = '/home/fs02/pmr82_0001/lbl59/Implementation_Uncertainty/' + \
    'post_processing/' + compSol_full + '/original_compromise_acrossRDM_'
# where original objectives across all solutions is stored (to change)
fileoutpath_bySoln_og = '/home/fs02/pmr82_0001/lbl59/Implementation_Uncertainty/' + \
    'post_processing/' + compSol_full + '/original_compromise_acrossSoln_'
