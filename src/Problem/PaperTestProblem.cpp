...
void PaperTestProblem::readInputData() {
    ...
    //rdm_tseries_dir = "/scratch/dfg42/WaterPaths_Sedento_reevaluation/DU_reeval/TestFiles" + BAR;
    //rdm_tseries_dir = "/scratch/dfg42/WaterPaths_Sedento_reevaluation/fixDU_reeval/testRDM1Files/rdm_" + to_string(rdm_no) + BAR;
   rdm_tseries_dir = "/home/fs02/pmr82_0001/lbl59/Implementation_Uncertainty/bootstrapped_reals/rdm_" + to_string(rdm_no) + BAR;
